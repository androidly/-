...
async function downloadAllImages() {
    ...
    showStatus(`准备下载 ${imageStates.length} 张图片，请按照浏览器的提示逐个保存`, 'info');
...
const modalContents = {
    ...
    about: { title: "关于", content: "<center>小番茄图片批量混淆工具延迟下载版</center><br>版本: 1.1.0 (WASM增强)<br>基于小番茄图片混淆进行深度修改。<br>此版本点击全部保存时将多张图以自动每秒一张的方式进行下载，可能能解决苹果设备不能一键保存多张的问题。<br>新增WASM加速，提升处理效率。<br><br><center>贴吧：然而他</center>" }
};
